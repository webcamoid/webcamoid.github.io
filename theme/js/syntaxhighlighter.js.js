 ...
 * 
 * @version
 * 4.0.1 (Tue, 13 Apr 2021 18:32:27 GMT)
 * 
 * @copyright
...
/***/ (function(module, exports, __webpack_require__) {
	...
	function Brush() {
	  ...
	  var specials = 'activate add alias ask attachment boolean class constant delete duplicate empty exists false id integer list make message modal modified new no paragraph pi properties quit real record remove rest result reveal reverse run running save string true word yes';
